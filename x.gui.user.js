...
// @downloadURL https://raw.githubusercontent.com/xgui-client/X-GUI-BLOOKET-CLIENT/refs/heads/main/x-gui%20cheats/X-GUI.JS
// @updateURL   https://raw.githubusercontent.com/xgui-client/X-GUI-BLOOKET-CLIENT/refs/heads/main/x-gui%20cheats/X-GUI.JS
...
.${classes.favoritesPage || "favoritesPage"}::-webkit-scrollbar-track {
  background: transparent;
        ...
        const versions = [
            ["Version 6.73x", "FIXED MAJOR BUG THAT BROKE ALL FIREBASE GAMEMODES AND ALOT OF OTHER FEATURES", "null"],
            ["Version 6.72x", "ADDED V7 OPTOMIZATIONS TO FIX BUGS, ADDED ESP TO MONSTER BRAWL, ADDED NEW SECTION CALLED HOST, AND ADDED ZOOM HACK.", "null"],
...
modulePage.append(modTitle, buttonGrid, clearAllContainer);
        ...
        codingCredits.append(createCredit("Design+Module Dev", "Lil Skittle+landsedge"));
